...
interface IHologramAccumulatorInterface extends ethers.utils.Interface {
  functions: {
...
export class IHologramAccumulator extends BaseContract {
  ...
  interface: IHologramAccumulatorInterface;
