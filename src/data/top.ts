...
export const CANCEL_TEXT =
  'If you would like to cancel your donation, you would take back donated ETH by burning your reciept NFT. If the project has already end, you should request refund, not cancel.'
...
export const REFUND_TEXT =
  'You may receive requests of refund as NFT from donors. It is not always necessary to respond. When you refund a donated ETH, you can do that from lists of refund request on the project page. After refund, the refund request NFT you have will be burned.'

export const WITHDRAW_TEXT =
  'You can withdraw donated ETH only after the project ends.'
...
export const FEE_TEXT =
  'Aurora DAO receive a 10% fee per project. It will be charged when the fundraisers withdraw donated ETH.'
