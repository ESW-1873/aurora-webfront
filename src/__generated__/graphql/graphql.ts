...
export type GetPostContentQuery = {
  ...
  postContent?: Maybe<{
    ...
    >
    refunded?: Maybe<
      Array<{ __typename?: 'Donation'; id: string; sender: string }>
    >
  }>
}
...
export type GetPostContentsQuery = {
  __typename?: 'Query'
  postContents: Array<{ __typename?: 'PostContent'; id: string }>
}
...
export const GetPostContentsDocument = gql`
  query GetPostContents($donee: Bytes!) {
    postContents(where: { donee: $donee }) {
      id
    }
  }
`
...
export function getSdk(
  ...
  return {
    GetPostContent(
      variables: GetPostContentQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetPostContentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPostContentQuery>(
    ...
    GetPostContents(
      variables: GetPostContentsQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetPostContentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPostContentsQuery>(
            GetPostContentsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'GetPostContents',
